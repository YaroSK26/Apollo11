        ...
        <div>
          <div className="flex gap-10 justify-center items-center mb-3">
            <section class="flex justify-center items-center">
              <a
                class="group flex justify-center p-2 rounded-md drop-shadow-xl bg-gradient-to-r  text-white font-semibold hover:scale-[1.1] hover:rounded-[50%] transition-all duration-500 from-gray-800  to-[#6E06D4]"
              ...
              >
                ...
                <span class="absolute  text-white text-sm -translate-y-10 duration-700">
                  GitHub
                </span>
              </a>
            </section>
            ...
            <section class="flex justify-center items-center">
              ...
              >
                ...
                <span class="absolute text- text-sm -translate-y-10 duration-700">
                  Instagram
                </span>
              </a>
            </section>
